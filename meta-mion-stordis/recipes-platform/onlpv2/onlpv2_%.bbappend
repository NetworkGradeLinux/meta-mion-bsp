...
URI_ONL_bf2556x = "git://github.com/apsnw/OpenNetworkLinuxv2.git;branch=${ONL_BRANCH}"
URI_ONL_bf6064x = "git://github.com/apsnw/OpenNetworkLinuxv2.git;branch=${ONL_BRANCH}"
