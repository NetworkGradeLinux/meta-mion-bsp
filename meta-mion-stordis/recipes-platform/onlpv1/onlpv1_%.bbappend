...
URI_ONL_bf2556x = "git://git@github.com/apsnw/OpenNetworkLinux.git;protocol=ssh;branch=${ONL_BRANCH}"
URI_ONL_bf6064x = "git://git@github.com/apsnw/OpenNetworkLinux.git;protocol=ssh;branch=${ONL_BRANCH}"
